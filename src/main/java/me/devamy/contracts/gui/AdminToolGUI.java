...
public class AdminToolGUI {
    ...
    private static final Consumer<InventoryClickEvent> viewWiki = e -> {
        ...
        e.getWhoClicked().sendRichMessage("<gray>>> <blue><u><click:open_url:'https://github.com/ImKarven/Contracts/wiki/Blacklist-&-Custom-items'>Click here</click></u> <white>to view the wiki");
    };
